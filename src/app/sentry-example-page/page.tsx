    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://projects-eduardo.sentry.io/issues/?project=4509311799590912">Issues Page</a>.
        ...
        <button
          ...
          onClick={async () => {
            ...
            throw new SentryExampleFrontendError("This error is raised on the frontend of the example page 22222.");
          }}
        >
          <span>
            Throw Sample Error
